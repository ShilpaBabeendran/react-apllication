     ...
     {/* <div className=" d-flex justify-content-between property-body mt-3 d-none d-md-block " style={{marginLeft:"5%", marginRight:"5%"}}> */}
            ...
            <div className= " property-card-parent d-none d-md-block "style={{ width:"72%"}}>
                ...
                <div className=" d-flex rounded-4 property-cardone-body"style={{backgroundColor:"#F1F1F399"}}>
                    ...
                    <div className="card-details p-2 pt-4">
                ...
                {[...Array(4)].map((_, index) => (
                    ...
                    <div key={index} className=" d-flex rounded-4 mt-2 property-cardone-body"style={{backgroundColor:"#F1F1F399"}}> 
        ...
        <div className=" d-flex rounded-4 d-block d-md-none property-cardone-body"style={{backgroundColor:"#F1F1F399"}}>
        ...
        <div className=" d-flex  property-body" style={{marginLeft:"5%", marginRight:"5%"}}>
            <div className= " property-card-parent " style={{ width:"72%"}}>
                {[...Array(4)].map((_, index) => (

                    <div key={index} className=" d-flex rounded-4 mb-2 property-cardone-body"style={{backgroundColor:"#F1F1F399" }}> 
                ...
                <aside className="rigt-said   rounded-4 p-3 "style={{width:"27%"}}>
                    <div className="said-content ">
                                    
                        <div className="said-content-head">
                            <p className="support-map">Map support</p>
                            <p className="para-map d-flex justify-content-center">Use our map support to find the property</p>
                        </div>
                        <div className="content-img d-f-c d-flex justify-content-center">
                            <img src={Map} className="map-img"/>
                        </div>
                        <div className="content-btn cursor-pointer">
                            Explore
                        </div>
